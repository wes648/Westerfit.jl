...
precompile(qngen, (Real, Real))
precompile(hrot2, (Array{Float64}, Array{Int,2}))
precompile(hsr, (Array{Float64},Real, Real, Array{Int,2}))
precompile(hqu, (Array{Float64}, Real, Real, Array{Int,2}))
...
precompile(sz_op, (Array{Int}, Real, Real, Int))
precompile(sp_op, (Array{Int}, Real, Real, Int))
